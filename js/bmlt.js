...
var bmltClientInit = function(host) {
    this.baseURL = host + "/client_interface/jsonp/?switcher=";
}
...
var getMeetingsByCity = function(city, callback) {
    getJSON(baseURL + "GetSearchResults" + "&meeting_key=location_municipality&meeting_key_value=" + city + "&callback=?", callback);
};

var getMeetingsByServiceBodyId = function(serviceBodyId, callback) {
    getJSON(baseURL + "GetSearchResults" + getServiceBodyIdQueryString(serviceBodyId) + "&callback=?", callback);
};

var getMeetingsByServiceBodyIdAndWeekdayId = function(serviceBodyId, weekdayId, callback) {
    getJSON(baseURL + "GetSearchResults" + getServiceBodyIdQueryString(serviceBodyId) + "&weekdays=" + weekdayId + "&callback=?", callback);
};

var getMeetingsByServiceBodyIdAndCity = function(serviceBodyId, city, callback) {
    getJSON(baseURL + "GetSearchResults" + getServiceBodyIdQueryString(serviceBodyId) + "&meeting_key=location_municipality&meeting_key_value=" + city + "&callback=?", callback);
};
